...
- **[WASM & TeX Live](docs/engine.md)**: Deep dive into the WebAssembly engine setup, TeX Live CDN integration, and asset resolution logic. Required for engine or network-related fixes.
